...
{
    /// <summary>
    /// Provides reference to the games color palette
    /// </summary>
    public static class ColorHelper
    {
        private static readonly Color[] oranges =
        {
        ...
        private static readonly Color[] yellows =
        {
        ...
        private static readonly Color[] teals =
        {
        ...
        private static readonly Color[] blues =
        {
        ...
        private static readonly Color[] purples =
        {
        ...
        private static readonly Color[] reds =
        {
        ...
        public static Color GetColor(ColorPallete baseColor, ColorShade shade)
        {
            switch (baseColor)
            {
                case ColorPallete.Orange:
                    return oranges[(int) shade];

                case ColorPallete.Yellow:
                    return yellows[(int) shade];

                case ColorPallete.Green:
                    return greens[(int) shade];

                case ColorPallete.Teal:
                    return teals[(int) shade];

                case ColorPallete.Blue:
                    return blues[(int) shade];

                case ColorPallete.Purple:
                    return purples[(int) shade];

                case ColorPallete.Red:
                    return reds[(int) shade];

                case ColorPallete.Brown:
                    return browns[(int) shade];

                default:
                    throw new ArgumentOutOfRangeException(nameof(baseColor), baseColor, null);
            }
        }
